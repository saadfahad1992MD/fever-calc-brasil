...
import { medicationsBrasil } from './data/medicationsBrasil.js'

function AppBrasilEnglish({ onChangeLanguage, country = 'DEFAULT' }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      {/* {country !== 'PH' && (
        <LanguageToggle currentLanguage="en" targetLanguage="pt" onToggle={onChangeLanguage} />
      )} */}
      {/* Top Brand Header */}
...
export default AppBrasilEnglish
